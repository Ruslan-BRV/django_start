# Generated by Django 4.2 on 2024-04-07 15:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('check_status', models.BooleanField(choices=[(False, 'Не проверено'), (True, 'Проверено')], db_column='CheckStatus', default=0)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='card',
            name='category',
            field=models.ForeignKey(db_column='CategoryID', default=5, on_delete=django.db.models.deletion.CASCADE, to='cards.category', verbose_name='Категория'),
        ),
        migrations.AddField(
            model_name='card',
            name='tags',
